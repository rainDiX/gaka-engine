...
# This is a modified version of FindVulkan to add the local Vulkan-Hpp headers
# modifications have a comment starting with GAKA:
...
if(WIN32)
  ...
  # GAKA: add local search path
  set(_Vulkan_hint_include_search_paths
    "${CMAKE_CURRENT_LIST_DIR}/../externals/Vulkan-Hpp/Vulkan-Headers/include"
...
#GAKA: Vulkan-Hpp search_path
set(_Vulkan_Hpp_hint_include_search_paths
  "${CMAKE_CURRENT_LIST_DIR}/../externals/Vulkan-Hpp"
)

#GAKA: match vulkan HPP with its vulkan-headers
...
# GAKA: Search Vulkan-Hpp
find_path(Vulkan_Hpp_INCLUDE_DIR
  NAMES vulkan/vulkan.hpp
  HINTS
    ${_Vulkan_Hpp_hint_include_search_paths}
  NO_DEFAULT_PATH
)
mark_as_advanced(Vulkan_Hpp_INCLUDE_DIR)
...
#Gaka: Add Vulkan-Hpp to INCLUDE_DIRS
set(Vulkan_INCLUDE_DIRS ${Vulkan_Hpp_INCLUDE_DIR} ${Vulkan_INCLUDE_DIR})
...
# GAKA: use global FindPackageHandleStandardArgs
