...
SDLOpenGLWindow::SDLOpenGLWindow(const std::string& title, int width, int height, bool fullscreen, bool vsync) {
    ...
    // SDL window creation
    // --------------------
    m_window = SDL_CreateWindow(title.c_str(), SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, m_state.width,
                                m_state.height, flags);
